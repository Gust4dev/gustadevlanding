          ...
          <div className="lg:col-span-5 relative group">
            ...
            <div className="relative aspect-[3/4] rounded-2xl overflow-hidden glass">
              <motion.img
                ...
                style={{
                  transformOrigin: `${PROFILE_CONFIG.positionX || "50%"} ${
                    PROFILE_CONFIG.positionY || "50%"
                  }`,
                  transform: `scale(${PROFILE_CONFIG.zoom || 1})`,
                }}
          ...
          <div className="lg:col-span-7 space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-secondary text-xl font-light leading-relaxed max-w-2xl">
                Como Arquiteto de SaaS e Engenheiro Full-Cycle, meu foco não é
                apenas "codar", mas construir ecossistemas digitais resilientes,
                escaláveis e esteticamente impecáveis.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-12 border-t border-white/5 pt-12">
              <div className="space-y-4">
                ...
                <p className="text-secondary/60 text-sm leading-relaxed">
                  Desenvolvimento de arquiteturas baseadas em microserviços e
              ...
              <div className="space-y-4">
                ...
                <p className="text-secondary/60 text-sm leading-relaxed">
                  Experiência em projetos internacionais focados em performance
                  extrema.
                </p>
              </div>
            </div>
