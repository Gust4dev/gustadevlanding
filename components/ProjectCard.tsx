      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 space-y-2">
            ...
            <div className="text-[10px] text-secondary uppercase tracking-tighter">
              Performance
            </div>
        ...
        <div className="flex flex-wrap gap-2">
          {project.tags.map((tag, i) => (
            <span
              key={i}
              className="text-[9px] font-mono text-accent/60 bg-accent/5 px-2 py-1 rounded"
            >
              {tag}
            </span>
          ))}
        ...
        <div className="flex gap-6 pt-4">
          <a
            ...
            className="text-white hover:text-accent transition-colors flex items-center gap-2 text-sm font-bold"
          >
